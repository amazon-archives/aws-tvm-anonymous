...
public class DeviceAuthentication {
	...
	/**
	 * Attempts to register the UID, Key combination. This method is used to register device using anonymous userid. Returns true if successful, false
	 ...
	 */
	public boolean registerDevice( String uid, String key ) {
		try {
			if ( checkUidExists( uid ) )
				return false;
			this.storeDevice( uid, key );
	 ...
	 */
	protected void storeDevice( String uid, String key ) {
